...
class WithMatch extends Mixin_1.MixinClause {
    ...
    match(clauseOrPattern) {
        if (clauseOrPattern instanceof __1.Match) {
            this.addNextClause(clauseOrPattern);
            return clauseOrPattern;
        }
        const matchClause = new __1.Match(clauseOrPattern);
    ...
    optionalMatch(clauseOrPattern) {
        if (clauseOrPattern instanceof __1.OptionalMatch) {
            this.addNextClause(clauseOrPattern);
            return clauseOrPattern;
        }
        const matchClause = new __1.OptionalMatch(clauseOrPattern);
        this.addNextClause(matchClause);
        return matchClause;
    }
}
